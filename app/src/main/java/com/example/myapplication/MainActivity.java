...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Remove the OnClickListener for the reload button
        ...
        reloadButton.setOnClickListener(view -> {
            closeCloudSession(() -> {
                // Cloud session is closed, proceed with starting NewActivity
    ...
    private void closeCloudSession(Runnable onSessionClosed) {
        // Close the cloud session asynchronously
        AsyncTask.execute(() -> {
            cloudSession.close();
            cloudSession = null;
            // Call the callback once the session is closed
            runOnUiThread(onSessionClosed);
        });
    }
